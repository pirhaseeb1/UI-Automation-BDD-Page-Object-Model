@website
Feature: As an anonymous user I should be able to learn about conveyancing from the services for buyers tab

    #Scenario: 1
  Scenario: User should be able to see a hero image with text Be Buyer Ready Solicitors hand-picked for their expertise, speed & efficiency
